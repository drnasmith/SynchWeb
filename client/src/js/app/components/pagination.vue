<template>
    <div class="content">
        ...
        <button v-on:click="onFirst" class="button">
            <i class="fa fa-angle-double-left" style="font-size: 1rem;"></i>
        </button>
        <button v-on:click="onPrev" class="button">
            <i class="fa fa-angle-left" style="font-size: 1rem;"></i>
        </button>
        ...
        <button v-on:click="onLast" class="button">
            <i class="fa fa-angle-double-right" style="font-size: 1rem;"></i>
        </button>
    </div>
</template>
